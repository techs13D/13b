...
import org.photogallery.galeriavault.asynctasks.CopyMoveTask
import org.photogallery.galeriavault.dialogs.*
import org.photogallery.galeriavault.dialogs.WritePermissionDialog.Mode
import org.photogallery.galeriavault.extensions.*
import org.photogallery.galeriavault.helpers.*
import org.photogallery.galeriavault.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("org.photogallery")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("org.photogallery.")
