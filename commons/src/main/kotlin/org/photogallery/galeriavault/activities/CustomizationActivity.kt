...
import org.photogallery.galeriavault.dialogs.*
import org.photogallery.galeriavault.extensions.*
import org.photogallery.galeriavault.helpers.*
import org.photogallery.galeriavault.models.MyTheme
import org.photogallery.galeriavault.models.RadioItem
import org.photogallery.galeriavault.models.SharedTheme
import org.photogallery.galeriavault.views.MyTextView
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupOptionsMenu()
        refreshMenuItems()
        isThankYou = packageName.removeSuffix(".debug") == ""
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("org.photogallery.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
