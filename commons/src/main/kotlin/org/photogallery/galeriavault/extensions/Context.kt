...
import org.photogallery.galeriavault.models.AlarmSound
...
fun Context.isAProApp() = packageName.startsWith("org.photogallery.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("org.photogallery."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("") && !packageName.startsWith("")) {
        true
    } else if ((packageName.startsWith("") || packageName.startsWith("")) && isQPlus()) {
